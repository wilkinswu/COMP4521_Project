...
import com.example.comp4521_project.data.LoginRepository;
import com.example.comp4521_project.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(LoginActivity loginActivity, String username, String password) {
        ...
        Result<LoggedInUser> result = loginRepository.login(loginActivity, username, password);
